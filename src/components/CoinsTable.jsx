...
const {currencys, symbol} = CryptoState();
  ...
  <Container style={{
    ...
    <TextField label="Search For a Crypto Currency..." variant="outlined" style={{
          ...
          <TableBody>
            ...
            <TableRow onClick={()=> navigate(`/coins/${row.id}`)}
              ...
              <TableCell component="th" scope="row" style={{
                ...
                <img src={row ?.image} alt={row.name} height="50" style={{
                            marginBottom: 10
                          }} />
                <div style={{
                            display: "flex",
      ...
      <Pagination style={{
        ...
        }} className={classes.pagination} count={(handleSearch()?.length/10).toFixed(0)} onChange={(_,value)=> {
        setPage(value);
        window.scroll(0,450)
        }}
        />
